...
def select_folder():
    global model, folder_path, train_loader  # Access the global model variable
    ...
    if folder_path:
        ...
        train_neural_network_with_metrics(model, train_loader, criterion, optimizer, num_epochs=train_amount)

# Function to handle the "Train another 10 epochs" button
def train_additional_epochs():
    global model, train_loader, criterion, optimizer, train_amount
